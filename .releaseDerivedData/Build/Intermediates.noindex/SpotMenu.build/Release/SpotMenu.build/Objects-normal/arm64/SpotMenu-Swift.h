...
#ifndef SPOTMENU_SWIFT_H
#define SPOTMENU_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SpotMenu",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
@class NSURL;
SWIFT_CLASS("_TtC8SpotMenu11AppDelegate")
...
@class AVAudioPlayer;
SWIFT_CLASS("_TtC8SpotMenu21MusicFolderController")
@interface MusicFolderController : NSObject <AVAudioPlayerDelegate>
...
@class NSResponder;
@class NSEvent;
SWIFT_CLASS("_TtC8SpotMenu13PopoverWindow")
...
- (BOOL)makeFirstResponder:(NSResponder * _Nullable)responder;
